import{t as p,e as d,f as Q}from"../chunks/D4bv8F4E.js";import{O as B,K as t,L as a,M as e,J as H,P as r}from"../chunks/BMLtCLay.js";import{s as h}from"../chunks/Dm6pbsMe.js";import{B as N}from"../chunks/DLrOGqhD.js";import{C as i}from"../chunks/D3Yeo-UB.js";import{D as $}from"../chunks/k_Nndnxw.js";import{a as J}from"../chunks/DsEF84c5.js";import{s as ee}from"../chunks/B-GZeXoY.js";var te=p('<sup class="font_mono"><a> </a></sup>');function L(m,s){var o=te(),n=t(o),l=t(n);a(n),a(o),B(()=>{h(n,"id",`footnote_link_${s.number??""}`),h(n,"href",`#footnote_${s.number??""}`),J(l,`[${s.number??""}]`)}),d(m,o)}var ae=p('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function U(m,s){var o=ae(),n=t(o),l=t(n),u=t(l);a(l),a(n);var f=e(n,2);ee(f,()=>s.children),a(o),B(()=>{h(o,"id",`footnote_${s.number??""}`),h(l,"href",`#footnote_link_${s.number??""}`),J(u,`[${s.number??""}]`)}),d(m,o)}const ie={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://fosstodon.org/@webdevladder/113312123824800794"}};var se=p("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),oe=p(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
...
`});var w=e(T,4),q=e(t(w));L(q,{number:1}),r(),a(w);var R=e(w,8),E=e(t(R),3);L(E,{number:2}),r(),a(R),r(2),a(y);var k=e(y,2),A=e(t(k),2),X=t(A);h(X,"href",s),r(),a(A);var G=e(A,8);i(G,{lang:"ts",content:"$: ab = a + ' ' + b;"});var P=e(G,4);i(P,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var j=e(P,4);i(j,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var x=e(j,2),Z=t(x);$(Z,{summary:v=>{r();var c=Q(`Here are the same lines verbatim from the demo, including the added
					noise:`);d(v,c)},children:(v,c)=>{var F=se(),O=e(H(F),2);i(O,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var z=e(O,4);i(z,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
	...
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),d(v,F)},$$slots:{summary:!0,default:!0}}),a(x);var K=e(x,2),C=e(t(K));h(C,"href",s),r(),a(K),r(6),a(k);var M=e(k,4),V=e(t(M),2);U(V,{number:1,children:(g,v)=>{var c=oe();d(g,c)}});var Y=e(V,2);U(Y,{number:2,children:(g,v)=>{var c=ne();d(g,c)}}),a(M),d(o,l)},$$slots:{default:!0}})}export{ge as component};
