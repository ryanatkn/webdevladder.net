import{c as t,a as c,t as h,r as a,s as e,f as ve,Y as i}from"../chunks/disclose-version.BYBXgRTm.js";import{a as p}from"../chunks/attributes.D3tYDR4N.js";import{B as wt}from"../chunks/Blog_Post.DIsqY5Xn.js";import{C as r}from"../chunks/Code.Di8R_7WS.js";import{D as _t}from"../chunks/Details.CdcsDgcH.js";import{t as fe,p as At,a as kt}from"../chunks/runtime.DaMnY2TH.js";import{s as be}from"../chunks/render.Cfeg4UTt.js";import{s as xt}from"../chunks/snippet.CQl_kiRo.js";var St=h('<sup class="font_mono"><a> </a></sup>');function me(u,s){var o=St(),l=t(o),d=t(l);a(l),a(o),fe(()=>{p(l,"id",`footnote_link_${s.number??""}`),p(l,"href",`#footnote_${s.number??""}`),be(d,`[${s.number??""}]`)}),c(u,o)}var It=h('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function ge(u,s){At(s,!0);var o=It(),l=t(o),d=t(l),v=t(d);a(d),a(l);var m=e(e(l,!0));xt(m,()=>s.children),a(o),fe(()=>{p(o,"id",`footnote_${s.number??""}`),p(d,"href",`#footnote_link_${s.number??""}`),be(v,`[${s.number??""}]`)}),c(u,o),kt()}var Tt=h(`Here are the same lines verbatim from the demo, including the added
			...
			signals implementation gives us, updating values is error-prone.</aside> <p>One important detail here is that signals do allow reading intermediate values. If you read <code>fullname</code> in between the two updates, you will indeed see the same value as the glitch. This makes sense,
