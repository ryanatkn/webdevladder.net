import{c as t,a as c,t as h,r as a,s as e,f as ue,Y as s}from"../chunks/disclose-version.BYBXgRTm.js";import{a as p}from"../chunks/attributes.D3tYDR4N.js";import{B as yt}from"../chunks/Blog_Post.DIsqY5Xn.js";import{C as r}from"../chunks/Code.Di8R_7WS.js";import{D as wt}from"../chunks/Details.CdcsDgcH.js";import{t as fe,p as _t,a as At}from"../chunks/runtime.DaMnY2TH.js";import{s as ge}from"../chunks/render.Cfeg4UTt.js";import{s as xt}from"../chunks/snippet.CQl_kiRo.js";var St=h('<sup class="font_mono"><a> </a></sup>');function ve(u,i){var o=St(),l=t(o),d=t(l);a(l),a(o),fe(()=>{p(l,"id",`footnote_link_${i.number??""}`),p(l,"href",`#footnote_${i.number??""}`),ge(d,`[${i.number??""}]`)}),c(u,o)}var kt=h('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function me(u,i){_t(i,!0);var o=kt(),l=t(o),d=t(l),v=t(d);a(d),a(l);var m=e(e(l,!0));xt(m,()=>i.children),a(o),fe(()=>{p(o,"id",`footnote_${i.number??""}`),p(d,"href",`#footnote_link_${i.number??""}`),ge(v,`[${i.number??""}]`)}),c(u,o),At()}var It=h(`Here are the same lines verbatim from the demo, including the added
					noise:`,1),Tt=h("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),Rt=h(`<p>Not all signals implementations are glitch-free, as I understand the term. For example <a href="https://www.youtube.com/watch?v=IsJtmbvW2SI">my first video</a> describes glitchy values that are possible in the store-compatible <a href="https://github.com/preactjs/signals">Preact Signals</a> library (starting at <a href="https://youtu.be/IsJtmbvW2SI?si=V1HVyf_IGs02ZWP-&amp;t=164">this timestamp</a>). Preact
				...
				Svelte 5's tradeoffs.</p>`),Gt=h(`<p>The deferred effects of Svelte 5's signals have good ergonomics, but like reactive
				...
				I'd love to learn more about this if you have resources to share.</p>`),Pt=h(`<section><aside>This blog post is also a <a href="https://www.youtube.com/watch?v=lcnimZTNOCA">video</a>.</aside> <p><a href="https://svelte.dev/">Svelte</a> is a frontend JS framework that's known in part for
			...
			years of using Svelte with solid productivity and good vibes.</p></section> <section><h2>Footnotes</h2> <!> <!></section>`,1);const jt={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://mastodon.social/@webdevladder/112966310136132406"}};function Kt(u){const i="https://svelte-5-preview.vercel.app/#H4sIAAAAAAAAA-1YzY7bNhB-lakrQHJiS2mLoIBXdlA0vRVokaSn9SKgpLHFhhYFcWSv4fhWtLee2zfp8-QF-goFSf3a8mZTZFGgyGG9Jufv45D8ZujDaMUFqtHs-jDK2AZHs9E3eT6ajGif64HaoiAcTUZKlkWsZ0IVFzynxTJbEt_ksiB4gSwmvsWXxAg
ep6O1GANArBwpUD_vP-pA-S6xJ4ADQJo3im9jflPyNXps6szRK96EpyHIViny2iO2fj7cWwL6uOz7AVQD0S0zgMyrfOwVOvcj2t7d6NPo84pzzqnROt8ENOax8V9Gdbeu4OQ66Pe47yQufIG7-a_bseqnyYawqzbsnq-JcsggA5f1s8br9uadSi3p-RH-4FNu9zi9QnzpNmjk19RPvV8n3q-_0nP1_vN4KO3ezfHfwC8rN4sFhcAAA==";yt(u,{post:jt,children:(o,l)=>{var d=Pt(),v=ue(d),m=t(v);e(t(m)),s(),a(m);var w=e(e(m,!0)),be=t(w),ye=e(e(be,!0)),we=e(e(ye,!0));e(e(we,!0)),s(),a(w);var _e=e(e(w,!0)),Y=e(e(_e,!0));r(Y,{content:`<script>
  let count = 1;
<\/script>

<button on:click={() => count++}>
  {count}
</button>`});var Ae=e(e(Y,!0)),xe=e(e(Ae,!0)),_=e(e(xe,!0)),Se=t(_);e(e(Se,!0)),a(_);var ke=e(e(_,!0)),A=e(e(ke,!0)),Ie=e(t(A));e(e(Ie,!0)),s(),a(A);var $=e(e(A,!0)),Te=e(t($));e(e(Te,!0)),s(),a($),a(v);var x=e(e(v,!0)),Re=t(x),S=e(e(Re,!0));e(t(S)),s(),a(S);var ee=e(e(S,!0));r(ee,{lang:"ts",content:`let a = 1;
$: b = a * 2;
setTimeout(() => {
	console.log(b); // 2
	a = 3;
...
`});var k=e(e(ee,!0));t(k),a(k);var I=e(e(k,!0)),Ge=e(t(I)),Pe=e(e(Ge,!0)),je=e(e(Pe,!0)),Ve=e(e(je,!0)),Oe=e(e(Ve,!0)),ze=e(e(Oe,!0)),Fe=e(e(ze,!0));e(e(Fe,!0)),s(),a(I);var te=e(e(I,!0));r(te,{lang:"ts",content:`let a = 1;
$: b = a * 2;
console.log(b); // undefined ???
`});var T=e(e(te,!0));t(T),a(T);var Me=e(e(T,!0)),ae=e(e(Me,!0));r(ae,{lang:"ts",content:`let a = $state(1);
const b = $derived(a * 2);
console.log(b); // 2 :)
setTimeout(() => {
	a = 3;
...
`});var R=e(e(ae,!0));t(R),a(R);var G=e(e(R,!0));e(t(G)),s(),a(G);var Be=e(e(G,!0));e(e(Be,!0)),a(x);var P=e(e(x,!0)),Ee=t(P),j=e(e(Ee,!0)),Ue=e(t(j)),Ke=e(e(Ue,!0)),Xe=e(e(Ke,!0));e(e(Xe,!0)),s(),a(j);var se=e(e(j,!0));r(se,{content:`// pseudo-code
firstname = 'Alan'
lastname  = 'Turing'
fullname  = firstname + ' ' + lastname
firstname = 'Barbara' // does code see 'Barbara Turing' here? if so it's a glitch
lastname  = 'Liskov'
`,lang:"ts"});var Le=e(e(se,!0)),V=e(e(Le,!0)),We=t(V),Ce=e(e(We,!0));e(e(Ce,!0)),a(V);var Je=e(e(V,!0)),ie=e(e(Je,!0));r(ie,{lang:"ts",content:`let firstname = writable('Barbara');
...
`});var O=e(e(ie,!0));t(O),a(O);var z=e(e(O,!0)),Qe=e(t(z));ve(Qe,{number:1}),s(),a(z);var F=e(e(z,!0));e(t(F)),s(),a(F);var He=e(e(F,!0)),M=e(e(He,!0)),qe=e(t(M)),De=e(e(qe,!0));ve(De,{number:2}),s(),a(M);var re=e(e(M,!0)),Ne=e(t(re)),Ze=e(e(Ne,!0));e(e(Ze,!0)),s(),a(re),a(P);var B=e(e(P,!0)),Ye=t(B),E=e(e(Ye,!0)),$e=t(E);p($e,"href",i),s(),a(E);var U=e(e(E,!0));e(t(U)),s(),a(U);var et=e(e(U,!0)),tt=e(e(et,!0)),oe=e(e(tt,!0));r(oe,{lang:"ts",content:"$: ab = a + ' ' + b;"});var at=e(e(oe,!0)),ne=e(e(at,!0));r(ne,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var st=e(e(ne,!0)),le=e(e(st,!0));r(le,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var K=e(e(le,!0)),it=t(K);wt(it,{summary:f=>{s();var n=It();c(f,n)},children:(f,n)=>{var b=Tt(),Z=ue(b),y=e(e(Z,!0));r(y,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var ft=e(e(y,!0)),pe=e(e(ft,!0));r(pe,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
});`});var gt=e(e(pe,!0)),bt=e(e(gt,!0));r(bt,{lang:"ts",content:`const ab = $derived.by(() => {
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),c(f,b)},$$slots:{default:!0}}),a(K);var X=e(e(K,!0)),rt=e(t(X));p(rt,"href",i),s(),a(X);var L=e(e(X,!0)),W=t(L),ot=e(t(W));e(e(ot,!0)),s(),a(W);var C=e(e(W,!0));e(t(C)),s(),a(C);var J=e(e(C,!0)),nt=e(t(J));e(e(nt,!0)),s(),a(J);var Q=e(e(J,!0)),lt=e(t(Q));e(e(lt,!0)),s(),a(Q);var de=e(e(Q,!0));e(t(de)),s(),a(de),a(L);var dt=e(e(L,!0));e(e(dt,!0)),a(B);var H=e(e(B,!0)),ct=t(H),q=e(e(ct,!0)),ht=e(t(q));e(e(ht,!0)),s(),a(q);var D=e(e(q,!0));e(t(D)),s(),a(D);var N=e(e(D,!0));e(t(N)),s(),a(N);var pt=e(e(N,!0)),ut=e(e(pt,!0));e(e(ut,!0)),a(H);var ce=e(e(H,!0)),vt=t(ce),he=e(e(vt,!0));me(he,{number:1,children:(g,f)=>{var n=Rt(),b=e(t(n)),Z=e(e(b,!0)),y=e(e(Z,!0));e(e(y,!0)),s(),a(n),c(g,n)},$$slots:{default:!0}});var mt=e(e(he,!0));me(mt,{number:2,children:(g,f)=>{var n=Gt();e(t(n)),s(),a(n),c(g,n)},$$slots:{default:!0}}),a(ce),c(o,d)},$$slots:{default:!0}})}export{Kt as component};
