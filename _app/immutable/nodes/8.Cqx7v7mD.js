import{a as d,t as p,b as Q}from"../chunks/disclose-version.B1p64p34.js";import{t as B,c as t,r as a,p as N,s as e,a as $,f as H,n as r}from"../chunks/runtime.BZB4EjX6.js";import{s as h}from"../chunks/attributes.BNql9Ezu.js";import{B as ee}from"../chunks/Blog_Post.CLJp9YKi.js";import{C as i}from"../chunks/Code.CvCAzkat.js";import{D as te}from"../chunks/Details.BCd1OMb4.js";import{s as W}from"../chunks/render.BJ6YWK3J.js";import{s as ae}from"../chunks/snippet.D3qCSCQx.js";var se=p('<sup class="font_mono"><a> </a></sup>');function L(m,s){var o=se(),n=t(o),l=t(n);a(n),a(o),B(()=>{h(n,"id",`footnote_link_${s.number??""}`),h(n,"href",`#footnote_${s.number??""}`),W(l,`[${s.number??""}]`)}),d(m,o)}var ie=p('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function U(m,s){$(s,!0);var o=ie(),n=t(o),l=t(n),u=t(l);a(l),a(n);var f=e(n,2);ae(f,()=>s.children),a(o),B(()=>{h(o,"id",`footnote_${s.number??""}`),h(l,"href",`#footnote_link_${s.number??""}`),W(u,`[${s.number??""}]`)}),d(m,o),N()}const oe={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://fosstodon.org/@webdevladder/113312123824800794"}};var ne=p("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),re=p(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
