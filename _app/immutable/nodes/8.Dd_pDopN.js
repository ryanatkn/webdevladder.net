import{c as t,a as c,t as h,r as a,s as e,f as ce,Y as s}from"../chunks/disclose-version.BYBXgRTm.js";import{a as p}from"../chunks/attributes.D3tYDR4N.js";import{B as mt}from"../chunks/Blog_Post.DIsqY5Xn.js";import{C as r}from"../chunks/Code.Di8R_7WS.js";import{D as ft}from"../chunks/Details.CdcsDgcH.js";import{t as ue,p as gt,a as bt}from"../chunks/runtime.DaMnY2TH.js";import{s as ve}from"../chunks/render.Cfeg4UTt.js";import{s as yt}from"../chunks/snippet.CQl_kiRo.js";var wt=h('<sup class="font_mono"><a> </a></sup>');function he(u,i){var o=wt(),l=t(o),d=t(l);a(l),a(o),ue(()=>{p(l,"id",`footnote_link_${i.number??""}`),p(l,"href",`#footnote_${i.number??""}`),ve(d,`[${i.number??""}]`)}),c(u,o)}var _t=h('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function pe(u,i){gt(i,!0);var o=_t(),l=t(o),d=t(l),v=t(d);a(d),a(l);var m=e(e(l,!0));yt(m,()=>i.children),a(o),ue(()=>{p(o,"id",`footnote_${i.number??""}`),p(d,"href",`#footnote_link_${i.number??""}`),ve(v,`[${i.number??""}]`)}),c(u,o),bt()}var At=h(`Here are the same lines verbatim from the demo, including the added
					noise:`,1),St=h("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),xt=h(`<p>Not all signals implementations are glitch-free, as I understand the term. For example <a href="https://www.youtube.com/watch?v=IsJtmbvW2SI">my first video</a> describes glitchy values that are possible in the store-compatible <a href="https://github.com/preactjs/signals">Preact Signals</a> library (starting at <a href="https://youtu.be/IsJtmbvW2SI?si=V1HVyf_IGs02ZWP-&amp;t=164">this timestamp</a>). Preact
				...
				Svelte 5's tradeoffs.</p>`),kt=h(`<p>The deferred effects of Svelte 5's signals have good ergonomics, but like reactive
				...
				I'd love to learn more about this if you have resources to share.</p>`),It=h(`<section><aside>This blog post is also a <a href="https://www.youtube.com/watch?v=lcnimZTNOCA">video</a>.</aside> <p><a href="https://svelte.dev/">Svelte</a> is a frontend JS framework that's known in part for
...
`});var k=e(e(D,!0));t(k),a(k);var I=e(e(k,!0)),Ie=e(t(I)),Te=e(e(Ie,!0)),Re=e(e(Te,!0)),Ge=e(e(Re,!0)),Pe=e(e(Ge,!0)),Ve=e(e(Pe,!0)),ze=e(e(Ve,!0));e(e(ze,!0)),s(),a(I);var $=e(e(I,!0));r($,{lang:"ts",content:`let a = 1;
$: b = a * 2;
...
`});var R=e(e(ee,!0));t(R),a(R);var G=e(e(R,!0));e(t(G)),s(),a(G);var Fe=e(e(G,!0));e(e(Fe,!0)),a(S);var P=e(e(S,!0)),Oe=t(P),V=e(e(Oe,!0)),Me=e(t(V)),Ue=e(e(Me,!0)),Ke=e(e(Ue,!0));e(e(Ke,!0)),s(),a(V);var te=e(e(V,!0));r(te,{content:`// pseudo-code
firstname = 'Alan'
lastname  = 'Turing'
fullname  = firstname + ' ' + lastname
firstname = 'Barbara' // does code see 'Barbara Turing' here? if so it's a glitch
lastname  = 'Liskov'
`,lang:"ts"});var Le=e(e(te,!0)),z=e(e(Le,!0)),Be=t(z),Je=e(e(Be,!0));e(e(Je,!0)),a(z);var j=e(e(z,!0)),Ee=e(t(j));he(Ee,{number:1}),s(),a(j);var F=e(e(j,!0));e(t(F)),s(),a(F);var We=e(e(F,!0)),O=e(e(We,!0)),Xe=e(t(O)),Ce=e(e(Xe,!0));he(Ce,{number:2}),s(),a(O);var ae=e(e(O,!0)),He=e(t(ae)),Ze=e(e(He,!0));e(e(Ze,!0)),s(),a(ae),a(P);var M=e(e(P,!0)),qe=t(M),U=e(e(qe,!0)),Qe=t(U);p(Qe,"href",i),s(),a(U);var K=e(e(U,!0));e(t(K)),s(),a(K);var Ye=e(e(K,!0)),Ne=e(e(Ye,!0)),se=e(e(Ne,!0));r(se,{lang:"ts",content:"$: ab = a + ' ' + b;"});var De=e(e(se,!0)),ie=e(e(De,!0));r(ie,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var $e=e(e(ie,!0)),re=e(e($e,!0));r(re,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var L=e(e(re,!0)),et=t(L);ft(et,{summary:f=>{s();var n=At();c(f,n)},children:(f,n)=>{var b=St(),Q=ce(b),y=e(e(Q,!0));r(y,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var pt=e(e(y,!0)),de=e(e(pt,!0));r(de,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
	...
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),c(f,b)},$$slots:{default:!0}}),a(L);var B=e(e(L,!0)),tt=e(t(B));p(tt,"href",i),s(),a(B);var J=e(e(B,!0)),E=t(J),at=e(t(E));e(e(at,!0)),s(),a(E);var W=e(e(E,!0));e(t(W)),s(),a(W);var X=e(e(W,!0)),st=e(t(X));e(e(st,!0)),s(),a(X);var C=e(e(X,!0)),it=e(t(C));e(e(it,!0)),s(),a(C);var oe=e(e(C,!0));e(t(oe)),s(),a(oe),a(J);var rt=e(e(J,!0));e(e(rt,!0)),a(M);var H=e(e(M,!0)),ot=t(H),Z=e(e(ot,!0)),nt=e(t(Z));e(e(nt,!0)),s(),a(Z);var q=e(e(Z,!0));e(t(q)),s(),a(q);var lt=e(e(q,!0)),dt=e(e(lt,!0));e(e(dt,!0)),a(H);var ne=e(e(H,!0)),ct=t(ne),le=e(e(ct,!0));pe(le,{number:1,children:(g,f)=>{var n=xt(),b=e(t(n)),Q=e(e(b,!0)),y=e(e(Q,!0));e(e(y,!0)),s(),a(n),c(g,n)},$$slots:{default:!0}});var ht=e(e(le,!0));pe(ht,{number:2,children:(g,f)=>{var n=kt();e(t(n)),s(),a(n),c(g,n)},$$slots:{default:!0}}),a(ne),c(o,d)},$$slots:{default:!0}})}export{Mt as component};
