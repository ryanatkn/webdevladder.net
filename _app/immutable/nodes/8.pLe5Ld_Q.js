import{c as t,a as c,t as h,r as a,s as e,f as ue,Y as s}from"../chunks/disclose-version.BYBXgRTm.js";import{a as p}from"../chunks/attributes.D3tYDR4N.js";import{B as wt}from"../chunks/Blog_Post.DIsqY5Xn.js";import{C as r}from"../chunks/Code.Di8R_7WS.js";import{D as _t}from"../chunks/Details.CdcsDgcH.js";import{t as fe,p as At,a as kt}from"../chunks/runtime.DaMnY2TH.js";import{s as ge}from"../chunks/render.Cfeg4UTt.js";import{s as xt}from"../chunks/snippet.CQl_kiRo.js";var St=h('<sup class="font_mono"><a> </a></sup>');function ve(u,i){var o=St(),l=t(o),d=t(l);a(l),a(o),fe(()=>{p(l,"id",`footnote_link_${i.number??""}`),p(l,"href",`#footnote_${i.number??""}`),ge(d,`[${i.number??""}]`)}),c(u,o)}var It=h('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function me(u,i){At(i,!0);var o=It(),l=t(o),d=t(l),v=t(d);a(d),a(l);var m=e(e(l,!0));xt(m,()=>i.children),a(o),fe(()=>{p(o,"id",`footnote_${i.number??""}`),p(d,"href",`#footnote_link_${i.number??""}`),ge(v,`[${i.number??""}]`)}),c(u,o),kt()}var Tt=h(`Here are the same lines verbatim from the demo, including the added
					noise:`,1),Rt=h("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),Gt=h(`<p>Not all signals implementations are glitch-free, as I understand the term. For example <a href="https://www.youtube.com/watch?v=IsJtmbvW2SI">my first video</a> describes glitchy values that are possible in the store-compatible <a href="https://github.com/preactjs/signals">Preact Signals</a> library (starting at <a href="https://youtu.be/IsJtmbvW2SI?si=V1HVyf_IGs02ZWP-&amp;t=164">this timestamp</a>). Preact
				...
				Svelte 5's tradeoffs.</p>`),Pt=h(`<p>The deferred effects of Svelte 5's signals have good ergonomics, but like reactive
				...
				I'd love to learn more about this if you have resources to share.</p>`),jt=h(`<section><aside>This blog post is also a <a href="https://www.youtube.com/watch?v=lcnimZTNOCA">video</a>.</aside> <p><a href="https://svelte.dev/">Svelte</a> is a frontend JS framework that's known in part for
			...
			when the code updates variables sequentially:</p> <!> <aside>It's possible I'm mis-using the term glitch here. (please send feedback with better
			terminology) The problem remains the same - without the implicit synchronous transactions that
			Svelte 5's signals implementation gives us, updating values is error-prone.</aside> <p>Glitches can be a source of:</p> <ul><li>bugs: what happens if you make an API call with a nonsense value? or will your frontend code
			...
			years of using Svelte with solid productivity and good vibes.</p></section> <section><h2>Footnotes</h2> <!> <!></section>`,1);const Vt={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://mastodon.social/@webdevladder/112966310136132406"}};function Bt(u){const i="https://svelte-5-preview.vercel.app/#H4sIAAAAAAAAA-1YzY7bNhB-lakrQHJiS2mLoIBXdlA0vRVokaSn9SKgpLHFhhYFcWSv4f
uo7xsBpOciJrjrb3mcup70RBVJZZHqm3X5z3543Lzd9mVK5A1VGOtERFgoUYvV428OWiRLVrLJjkd8oep6O1GANArBwpUD_vP-pA-S6xJ4ADQJo3im9jflPyNXps6szRK96EpyHIViny2iO2fj7cWwL6uOz7AVQD0S0zgMyrfOwVOvcj2t7d6NPo84pzzqnROt8ENOax8V9Gdbeu4OQ66Pe47yQufIG7-a_bseqnyYawqzbsnq-JcsggA5f1s8br9uadSi3p-RH-4FNu9zi9QnzpNmjk19RPvV8n3q-_0nP1_vN4KO3ezfHfwC8rN4sFhcAAA==";wt(u,{post:Vt,children:(o,l)=>{var d=jt(),v=ue(d),m=t(v);e(t(m)),s(),a(m);var w=e(e(m,!0)),be=t(w),ye=e(e(be,!0)),we=e(e(ye,!0));e(e(we,!0)),s(),a(w);var _e=e(e(w,!0)),N=e(e(_e,!0));r(N,{content:`<script>
  let count = 1;
<\/script>

<button on:click={() => count++}>
  {count}
</button>`});var Ae=e(e(N,!0)),ke=e(e(Ae,!0)),_=e(e(ke,!0)),xe=t(_);e(e(xe,!0)),a(_);var Se=e(e(_,!0)),A=e(e(Se,!0)),Ie=e(t(A));e(e(Ie,!0)),s(),a(A);var $=e(e(A,!0)),Te=e(t($));e(e(Te,!0)),s(),a($),a(v);var k=e(e(v,!0)),Re=t(k),x=e(e(Re,!0));e(t(x)),s(),a(x);var ee=e(e(x,!0));r(ee,{lang:"ts",content:`let a = 1;
$: b = a * 2;
setTimeout(() => {
	console.log(b); // 2
	a = 3;
...
`});var S=e(e(ee,!0));t(S),a(S);var I=e(e(S,!0)),Ge=e(t(I)),Pe=e(e(Ge,!0)),je=e(e(Pe,!0)),Ve=e(e(je,!0)),Fe=e(e(Ve,!0)),Ke=e(e(Fe,!0)),Me=e(e(Ke,!0));e(e(Me,!0)),s(),a(I);var te=e(e(I,!0));r(te,{lang:"ts",content:`let a = 1;
$: b = a * 2;
console.log(b); // undefined ???
`});var T=e(e(te,!0));t(T),a(T);var Oe=e(e(T,!0)),ae=e(e(Oe,!0));r(ae,{lang:"ts",content:`let a = $state(1);
const b = $derived(a * 2);
console.log(b); // 2 :)
setTimeout(() => {
	a = 3;
...
`});var R=e(e(ae,!0));t(R),a(R);var G=e(e(R,!0));e(t(G)),s(),a(G);var ze=e(e(G,!0));e(e(ze,!0)),a(k);var P=e(e(k,!0)),He=t(P),j=e(e(He,!0)),Le=e(t(j)),Ue=e(e(Le,!0)),Be=e(e(Ue,!0));e(e(Be,!0)),s(),a(j);var se=e(e(j,!0));r(se,{content:`// pseudo-code
firstname = 'Alan'
lastname  = 'Turing'
fullname  = firstname + ' ' + lastname
firstname = 'Barbara' // does code see 'Barbara Turing' here? if so it's a glitch
lastname  = 'Liskov'
`,lang:"ts"});var Ee=e(e(se,!0)),Je=e(e(Ee,!0)),V=e(e(Je,!0)),We=t(V),Xe=e(e(We,!0));e(e(Xe,!0)),a(V);var qe=e(e(V,!0)),ie=e(e(qe,!0));r(ie,{lang:"ts",content:`const firstname = writable('Barbara');
...
`});var F=e(e(ie,!0));t(F),a(F);var K=e(e(F,!0)),Ze=e(t(K));ve(Ze,{number:1}),s(),a(K);var M=e(e(K,!0));e(t(M)),s(),a(M);var Ce=e(e(M,!0)),O=e(e(Ce,!0)),Ye=e(t(O)),De=e(e(Ye,!0));ve(De,{number:2}),s(),a(O);var re=e(e(O,!0)),Qe=e(t(re)),Ne=e(e(Qe,!0));e(e(Ne,!0)),s(),a(re),a(P);var z=e(e(P,!0)),$e=t(z),H=e(e($e,!0)),et=t(H);p(et,"href",i),s(),a(H);var L=e(e(H,!0));e(t(L)),s(),a(L);var tt=e(e(L,!0)),at=e(e(tt,!0)),oe=e(e(at,!0));r(oe,{lang:"ts",content:"$: ab = a + ' ' + b;"});var st=e(e(oe,!0)),ne=e(e(st,!0));r(ne,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var it=e(e(ne,!0)),le=e(e(it,!0));r(le,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var U=e(e(le,!0)),rt=t(U);_t(rt,{summary:f=>{s();var n=Tt();c(f,n)},children:(f,n)=>{var b=Rt(),Q=ue(b),y=e(e(Q,!0));r(y,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var gt=e(e(y,!0)),pe=e(e(gt,!0));r(pe,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
});`});var bt=e(e(pe,!0)),yt=e(e(bt,!0));r(yt,{lang:"ts",content:`const ab = $derived.by(() => {
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),c(f,b)},$$slots:{default:!0}}),a(U);var B=e(e(U,!0)),ot=e(t(B));p(ot,"href",i),s(),a(B);var E=e(e(B,!0)),J=t(E),nt=e(t(J));e(e(nt,!0)),s(),a(J);var W=e(e(J,!0));e(t(W)),s(),a(W);var X=e(e(W,!0)),lt=e(t(X));e(e(lt,!0)),s(),a(X);var q=e(e(X,!0)),dt=e(t(q));e(e(dt,!0)),s(),a(q);var de=e(e(q,!0));e(t(de)),s(),a(de),a(E);var ct=e(e(E,!0));e(e(ct,!0)),a(z);var Z=e(e(z,!0)),ht=t(Z),C=e(e(ht,!0)),pt=e(t(C));e(e(pt,!0)),s(),a(C);var Y=e(e(C,!0));e(t(Y)),s(),a(Y);var D=e(e(Y,!0));e(t(D)),s(),a(D);var ut=e(e(D,!0)),vt=e(e(ut,!0));e(e(vt,!0)),a(Z);var ce=e(e(Z,!0)),mt=t(ce),he=e(e(mt,!0));me(he,{number:1,children:(g,f)=>{var n=Gt(),b=e(t(n)),Q=e(e(b,!0)),y=e(e(Q,!0));e(e(y,!0)),s(),a(n),c(g,n)},$$slots:{default:!0}});var ft=e(e(he,!0));me(ft,{number:2,children:(g,f)=>{var n=Pt();e(t(n)),s(),a(n),c(g,n)},$$slots:{default:!0}}),a(ce),c(o,d)},$$slots:{default:!0}})}export{Bt as component};
