import{a as h,f as u}from"../chunks/BiFwoq1N.js";import{a as f}from"../chunks/C5YRNmTz.js";import{p as y,a as w,aI as g,f as b,s,c as r,ac as i,r as d,t as v}from"../chunks/CvP6vg0C.js";import{s as I}from"../chunks/Dyfn4W2H.js";import{B as k,a as z}from"../chunks/DWrOmGv3.js";const _={title:"Introducing Webdevladder",slug:"introducing-webdevladder",date_published:"2024-08-14T18:10:26.092Z",date_modified:"2025-06-28T23:31:20.100Z",summary:"I describe the purpose of my YouTube channel and blog, Webdevladder, and my plans for the future",tags:["webdevladder"],comments:{type:"mastodon",url:"https://fosstodon.org/@webdevladder/113312132188029470"}};var x=u(`<section><p>Webdevladder is a <a href="https://youtube.com/@webdevladder">YouTube channel</a> and <a href="https://www.webdevladder.net/blog">blog</a> about the technical topics that interest
			...
			2024 I created this alias and site to gain some distance).</p> <p>The open web is humanity's shared, decentralized platform. I love it for its wide reach and
			...
			other software has been designed for.</p> <p>My stated goal here is to deepen my knowledge of web technology and improve my communication
			...
			less polished content like raw programming sessions and demos of my apps on a <a href="https://youtube.com/@webdevladder_vods">second channel</a>.</p> <p>But before you subscribe to <a>the feed</a>, here's some more context.</p></section> <section><h2>What Webdevladder is not</h2> <p>I'm seeking to be an independent open source developer funded directly by my users, which is
			...
			company while keeping independence on my open source projects.</p> <p>I share some similarities with a few contemporary archetypes, but there are important
			differences. The main point is that I'm devoting my time primarily to making software. All of
			the other stuff, like this blog, is supplementary.</p> <p>For one, I'm not a startup. I will never take investor funding for these projects or sell
			...
			they'll be owned by a nonprofit or equivalent.</p> <p>I'm also not an entertainer, influencer, or video content creator. Making software, not
			...
			supportive audience.</p> <p>And finally, I'm not a comprehensive educator. I won't retread the same beginner content
			...
			ladder that anyone could climb.</p></section> <section><h2>My plan</h2> <p>I'm lucky to have the resources to pursue my <a href="https://www.ryanatkn.com/tree">projects</a> for a few more years, and regardless of
			...
			a stickler for boundaries when it comes to what goes into the repos.</p> <p><a href="https://youtube.com/@webdevladder">@webdevladder</a> is a channel where I get to
			learn the ropes of video communication in a low pressure environment. My other channel <a href="https://youtube.com/@webdevladder_vods">@webdevladder_vods</a> gives me even lower
			pressure experience making videos related to my software and practices, including unfiltered
			programming sessions for those interested in learning that particular way.</p> <p>For more about me, see my <a href="https://www.ryanatkn.com/">personal website</a>.</p> <p>If any of this sounds interesting, there's all kinds of links and buttons to click. See you
			next time.</p></section>`,1);function F(l,p){y(p,!0),k(l,{get post(){return _},comments:(e,t=g)=>{z(e,{get item(){return t()}})},children:(e,t)=>{var o=x(),n=b(o),a=s(r(n),8),m=s(r(a));i(),d(a),d(n),i(4),v(c=>I(m,"href",c),[()=>f("/blog/feed.xml")]),h(e,o)},$$slots:{comments:!0,default:!0}}),w()}export{F as component};
