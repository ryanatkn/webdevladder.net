import{a as d,t as p,f as Q}from"../chunks/disclose-version.BsnlxLp3.js";import{t as B,c as t,r as a,p as N,a as $,s as e,f as H,au as r}from"../chunks/runtime.DXydPg0t.js";import{a as h}from"../chunks/attributes.D0oSGar9.js";import{B as ee}from"../chunks/Blog_Post.nDq7vkAJ.js";import{C as s}from"../chunks/Code.DmTmYsQ6.js";import{D as te}from"../chunks/Details.5L83apfk.js";import{s as W}from"../chunks/render.D7CCJaHe.js";import{s as ae}from"../chunks/snippet.BHe3b1nB.js";var ie=p('<sup class="font_mono"><a> </a></sup>');function L(m,i){var o=ie(),n=t(o),l=t(n);a(n),a(o),B(()=>{h(n,"id",`footnote_link_${i.number??""}`),h(n,"href",`#footnote_${i.number??""}`),W(l,`[${i.number??""}]`)}),d(m,o)}var se=p('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function U(m,i){N(i,!0);var o=se(),n=t(o),l=t(n),u=t(l);a(l),a(n);var g=e(n,2);ae(g,()=>i.children),a(o),B(()=>{h(o,"id",`footnote_${i.number??""}`),h(l,"href",`#footnote_link_${i.number??""}`),W(u,`[${i.number??""}]`)}),d(m,o),$()}var oe=p("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),ne=p(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
				...
				Svelte 5's tradeoffs.</p>`),re=p(`<p>The deferred effects of Svelte 5's signals have good ergonomics, but like reactive
				...
				I'd love to learn more about this if you have resources to share.</p>`),le=p(`<section><aside>This blog post is also a <a href="https://www.youtube.com/watch?v=lcnimZTNOCA">video</a>.</aside> <p><a href="https://svelte.dev/">Svelte</a> is a frontend JS framework that's known in part for
...
`});var _=e(S,6);s(_,{lang:"ts",content:`let a = 1;
$: b = a * 2;
console.log(b); // undefined ???
`});var E=e(_,6);s(E,{lang:"ts",content:`let a = $state(1);
const b = $derived(a * 2);
console.log(b); // 2 :)
setTimeout(() => {
	a = 3;
...
`}),r(8),a(b);var y=e(b,2),I=e(t(y),4);s(I,{content:`// pseudo-code
firstname = 'Alan'
lastname  = 'Turing'
fullname  = firstname + ' ' + lastname
firstname = 'Barbara' // does code see 'Barbara Turing' here? if so it's a glitch
lastname  = 'Liskov'
`,lang:"ts"});var T=e(I,8);s(T,{lang:"ts",content:`const firstname = writable('Barbara');
...
`});var w=e(T,4),J=e(t(w));L(J,{number:1}),r(),a(w);var R=e(w,8),X=e(t(R),3);L(X,{number:2}),r(),a(R),r(2),a(y);var A=e(y,2),k=e(t(A),2),q=t(k);h(q,"href",i),r(),a(k);var G=e(k,8);s(G,{lang:"ts",content:"$: ab = a + ' ' + b;"});var P=e(G,4);s(P,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var j=e(P,4);s(j,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var x=e(j,2),Z=t(x);te(Z,{summary:v=>{r();var c=Q(`Here are the same lines verbatim from the demo, including the added
					noise:`);d(v,c)},children:(v,c)=>{var M=oe(),O=e(H(M),2);s(O,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var z=e(O,4);s(z,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
});`});var D=e(z,4);s(D,{lang:"ts",content:`const ab = $derived.by(() => {
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),d(v,M)},$$slots:{default:!0}}),a(x);var V=e(x,2),C=e(t(V));h(C,"href",i),r(),a(V),r(6),a(A);var F=e(A,4),K=e(t(F),2);U(K,{number:1,children:(f,v)=>{var c=ne();d(f,c)},$$slots:{default:!0}});var Y=e(K,2);U(Y,{number:2,children:(f,v)=>{var c=re();d(f,c)},$$slots:{default:!0}}),a(F),d(o,l)},$$slots:{default:!0}})}export{be as component};
