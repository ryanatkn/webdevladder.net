...
`});var S=e(_,6);i(S,{lang:"ts",content:`let a = 1;
$: b = a * 2;
console.log(b); // undefined ???
`});var q=e(S,6);i(q,{lang:"ts",content:`let a = $state(1);
const b = $derived(a * 2);
console.log(b); // 2 :)
setTimeout(() => {
	a = 3;
...
`});var w=e(T,4),E=e(t(w));L(E,{number:1}),r(),a(w);var R=e(w,8),J=e(t(R),3);L(J,{number:2}),r(),a(R),r(2),a(y);var k=e(y,2),A=e(t(k),2),X=t(A);h(X,"href",s),r(),a(A);var G=e(A,8);i(G,{lang:"ts",content:"$: ab = a + ' ' + b;"});var j=e(G,4);i(j,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var P=e(j,4);i(P,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var x=e(P,2),Z=t(x);$(Z,{summary:v=>{r();var c=Q(`Here are the same lines verbatim from the demo, including the added
