import{f as v,a as c,t as Q,c as K}from"../chunks/CAWsFU00.js";import{b as ae,aX as ie,p as se,s as e,c as i,a as oe,r as s,t as O,f as S,w as u}from"../chunks/kwwnMzNm.js";import{a as Z,s as y}from"../chunks/BIfOhnna.js";import{B as ne}from"../chunks/D09KomE8.js";import{C as h}from"../chunks/C74loVAr.js";import{s as z}from"../chunks/CkEU7nMb.js";import{s as G}from"../chunks/CSmPUBOw.js";import{i as M}from"../chunks/CfSpEK_M.js";import{t as re,a as le}from"../chunks/CJFzU4xC.js";import{p as de,r as ce}from"../chunks/BCDInx-y.js";function he(p,t,a,d,o){var r=()=>{d(a[p])};a.addEventListener(t,r),o?ae(()=>{a[p]=o()}):r(),(a===document.body||a===window||a===document)&&ie(()=>{a.removeEventListener(t,r)})}var pe=v("<div><!></div>"),me=v("<details><summary><!></summary> <!></details>");function ue(p,t){se(t,!0);let a=de(t,"open",15),d=ce(t,["$$slots","$$events","$$legacy","open","eager","summary_attrs","summary","children"]);var o=me();Z(o,()=>({...d}));var r=i(o);Z(r,()=>({...t.summary_attrs}));var w=i(r);{var _=n=>{var l=Q();O(()=>z(l,t.summary)),c(n,l)},I=n=>{var l=K(),m=S(l);G(m,()=>t.summary),c(n,l)};M(w,n=>{typeof t.summary=="string"?n(_):n(I,!1)})}s(r);var T=e(r,2);{var j=n=>{var l=K(),m=S(l);G(m,()=>t.children),c(n,l)},k=n=>{var l=K(),m=S(l);{var P=f=>{var g=pe(),A=i(g);G(A,()=>t.children),s(g),re(3,g,()=>le),c(f,g)};M(m,f=>{a()&&f(P)},!0)}c(n,l)};M(T,n=>{t.eager?n(j):n(k,!1)})}s(o),he("open","toggle",o,a,a),c(p,o),oe()}var ve=v('<sup class="font_family_mono"><a> </a></sup>');function C(p,t){var a=ve(),d=i(a),o=i(d);s(d),s(a),O(()=>{y(d,"id",`footnote_link_${t.number??""}`),y(d,"href",`#footnote_${t.number??""}`),z(o,`[${t.number??""}]`)}),c(p,a)}var fe=v('<div class="mb_xl5"><span class="font_family_mono float_left mr_sm"><a> </a></span> <!></div>');function Y(p,t){var a=fe(),d=i(a),o=i(d),r=i(o);s(o),s(d);var w=e(d,2);G(w,()=>t.children),s(a),O(()=>{y(a,"id",`footnote_${t.number??""}`),y(o,"href",`#footnote_link_${t.number??""}`),z(r,`[${t.number??""}]`)}),c(p,a)}const ge={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://fosstodon.org/@webdevladder/113312123824800794"}};var be=v("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),ye=v(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
...
`});var m=e(l,4),P=e(i(m));C(P,{number:1}),u(),s(m);var f=e(m,8),g=e(i(f),3);C(g,{number:2}),u(),s(f),u(2),s(k);var A=e(k,2),V=e(i(A),2),D=i(V);y(D,"href",t),u(),s(V);var H=e(V,8);h(H,{lang:"ts",content:"$: ab = a + ' ' + b;"});var L=e(H,4);h(L,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var U=e(L,4);h(U,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var F=e(U,2),N=i(F);ue(N,{summary:x=>{u();var b=Q(`Here are the same lines verbatim from the demo, including the added
					noise:`);c(x,b)},children:(x,b)=>{var X=be(),q=e(S(X),2);h(q,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var J=e(q,4);h(J,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
});`});var te=e(J,4);h(te,{lang:"ts",content:`const ab = $derived.by(() => {
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),c(x,X)},$$slots:{summary:!0,default:!0}}),s(F);var B=e(F,2),$=e(i(B));y($,"href",t),u(),s(B),u(6),s(A);var E=e(A,4),W=e(i(E),2);Y(W,{number:1,children:(R,x)=>{var b=ye();c(R,b)}});var ee=e(W,2);Y(ee,{number:2,children:(R,x)=>{var b=we();c(R,b)}}),s(E),c(a,o)},$$slots:{default:!0}})}export{Ve as component};
