import{a as d,t as p,b as Q}from"../chunks/disclose-version.DzKeUQ2o.js";import{t as B,c as t,r as a,p as N,a as $,s as e,f as H,n as r}from"../chunks/runtime.DMEcuKpY.js";import{s as h}from"../chunks/attributes.CtxfuLEF.js";import{B as ee}from"../chunks/Blog_Post.CNOQhNfR.js";import{C as i}from"../chunks/Code.B2dOAb0N.js";import{D as te}from"../chunks/Details.DtUOyI0_.js";import{s as W}from"../chunks/render.BfHosblf.js";import{s as ae}from"../chunks/snippet.CipBxWGh.js";var se=p('<sup class="font_mono"><a> </a></sup>');function L(m,s){var o=se(),n=t(o),l=t(n);a(n),a(o),B(()=>{h(n,"id",`footnote_link_${s.number??""}`),h(n,"href",`#footnote_${s.number??""}`),W(l,`[${s.number??""}]`)}),d(m,o)}var ie=p('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function U(m,s){N(s,!0);var o=ie(),n=t(o),l=t(n),u=t(l);a(l),a(n);var f=e(n,2);ae(f,()=>s.children),a(o),B(()=>{h(o,"id",`footnote_${s.number??""}`),h(l,"href",`#footnote_link_${s.number??""}`),W(u,`[${s.number??""}]`)}),d(m,o),$()}const oe={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://mastodon.social/@webdevladder/112966310136132406"}};var ne=p("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),re=p(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
...
`});var w=e(T,4),E=e(t(w));L(E,{number:1}),r(),a(w);var R=e(w,8),J=e(t(R),3);L(J,{number:2}),r(),a(R),r(2),a(y);var k=e(y,2),A=e(t(k),2),X=t(A);h(X,"href",s),r(),a(A);var G=e(A,8);i(G,{lang:"ts",content:"$: ab = a + ' ' + b;"});var j=e(G,4);i(j,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var P=e(j,4);i(P,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var x=e(P,2),Z=t(x);te(Z,{summary:v=>{r();var c=Q(`Here are the same lines verbatim from the demo, including the added
					noise:`);d(v,c)},children:(v,c)=>{var M=ne(),O=e(H(M),2);i(O,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var z=e(O,4);i(z,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
	...
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),d(v,M)},$$slots:{summary:!0,default:!0}}),a(x);var V=e(x,2),C=e(t(V));h(C,"href",s),r(),a(V),r(6),a(k);var F=e(k,4),K=e(t(F),2);U(K,{number:1,children:(g,v)=>{var c=re();d(g,c)},$$slots:{default:!0}});var Y=e(K,2);U(Y,{number:2,children:(g,v)=>{var c=le();d(g,c)},$$slots:{default:!0}}),a(F),d(o,l)},$$slots:{default:!0}})}export{be as component};
