import{e as d,t as p,f as D}from"../chunks/disclose-version.Dn2LuS9l.js";import{O as B,L as t,M as a,I as N,G as $,K as e,J as H,Q as r}from"../chunks/runtime.WHH172tf.js";import{s as h}from"../chunks/attributes.QTCS8sk-.js";import{B as ee}from"../chunks/Blog_Post.DjTVoWMH.js";import{C as i}from"../chunks/Code.C447Y5Si.js";import{D as te}from"../chunks/Details.Of-_ezMA.js";import{a as J}from"../chunks/render.DakY9b14.js";import{s as ae}from"../chunks/snippet.BxweYsNG.js";var se=p('<sup class="font_mono"><a> </a></sup>');function L(m,s){var o=se(),n=t(o),l=t(n);a(n),a(o),B(()=>{h(n,"id",`footnote_link_${s.number??""}`),h(n,"href",`#footnote_${s.number??""}`),J(l,`[${s.number??""}]`)}),d(m,o)}var ie=p('<div class="mb_xl5"><span class="font_mono float_left mr_sm"><a> </a></span> <!></div>');function U(m,s){$(s,!0);var o=ie(),n=t(o),l=t(n),u=t(l);a(l),a(n);var f=e(n,2);ae(f,()=>s.children),a(o),B(()=>{h(o,"id",`footnote_${s.number??""}`),h(l,"href",`#footnote_link_${s.number??""}`),J(u,`[${s.number??""}]`)}),d(m,o),N()}const oe={title:"Svelte 5 signals fix its glitchy and inconsistent reactivity",slug:"svelte-5-signals-fix-its-glitchy-and-inconsistent-reactivity",date_published:"2024-08-15T12:53:55.522Z",date_modified:"2024-08-15T12:53:55.522Z",summary:"Svelte 5 adopted signals to replace its old reactivity system that had some subtle but important problems",tags:["svelte","signals"],comments:{type:"mastodon",url:"https://fosstodon.org/@webdevladder/113312123824800794"}};var ne=p("<p>Reactive statements:</p> <!> <p>Derived stores:</p> <!> <p>Signals:</p> <!>",1),re=p(`<p>Not all signals implementations are glitch-free, as I understand the term. (in hindsight I
				...
				Svelte 5's tradeoffs.</p>`),le=p(`<p>The deferred effects of Svelte 5's signals have good ergonomics, but like reactive
				...
				I'd love to learn more about this if you have resources to share.</p>`),de=p(`<section><aside>This blog post is also a <a href="https://www.youtube.com/watch?v=lcnimZTNOCA">video</a>.</aside> <p><a href="https://svelte.dev/">Svelte</a> is a frontend JS framework that's known in part for
...
`});var W=e(_,6);i(W,{lang:"ts",content:`let a = $state(1);
const b = $derived(a * 2);
console.log(b); // 2 :)
setTimeout(() => {
	a = 3;
...
`});var w=e(T,4),q=e(t(w));L(q,{number:1}),r(),a(w);var R=e(w,8),E=e(t(R),3);L(E,{number:2}),r(),a(R),r(2),a(y);var k=e(y,2),A=e(t(k),2),X=t(A);h(X,"href",s),r(),a(A);var G=e(A,8);i(G,{lang:"ts",content:"$: ab = a + ' ' + b;"});var j=e(G,4);i(j,{lang:"ts",content:"const ab = derived([a, b], ([$a, $b]) => $a + ' ' + $b);"});var P=e(j,4);i(P,{lang:"ts",content:"const ab = $derived(a + ' ' + b);"});var x=e(P,2),Z=t(x);te(Z,{summary:v=>{r();var c=D(`Here are the same lines verbatim from the demo, including the added
					noise:`);d(v,c)},children:(v,c)=>{var F=ne(),O=e(H(F),2);i(O,{lang:"ts",content:"$: ab = log('deriving: ' + a + ' ' + b) || a + ' ' + b;"});var z=e(O,4);i(z,{lang:"ts",content:`const ab = derived([a, b], ([$a, $b]) => {
	const $ab = $a + ' ' + $b;
	log('deriving: ' + $ab);
	return $ab;
});`});var Y=e(z,4);i(Y,{lang:"ts",content:`const ab = $derived.by(() => {
	log('deriving: ' + a + ' ' + b);
	return a + ' ' + b;
})`}),d(v,F)},$$slots:{summary:!0,default:!0}}),a(x);var K=e(x,2),C=e(t(K));h(C,"href",s),r(),a(K),r(6),a(k);var M=e(k,4),V=e(t(M),2);U(V,{number:1,children:(g,v)=>{var c=re();d(g,c)},$$slots:{default:!0}});var Q=e(V,2);U(Q,{number:2,children:(g,v)=>{var c=le();d(g,c)},$$slots:{default:!0}}),a(M),d(o,l)},$$slots:{default:!0}})}export{be as component};
